        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    businessOwners.forEach(function (user, index) {
                        console.log("\nUser ".concat(index + 1, ":"));
                        ...
                        console.log("Has business relation: ".concat(user.business !== null));
                        console.log("Has managed business: ".concat(user.managedBusiness !== null));
                        if (user.managedBusiness) {
                            console.log('\nManaged Business Details:');
                            console.log("ID: ".concat(user.managedBusiness.id));
                            console.log("Name: ".concat(user.managedBusiness.name));
                        }
                    });
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error checking user business:', error_1);
                    return [3 /*break*/, 5];
